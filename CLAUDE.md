...
- Fixed site-wide nav bar (`<nav class="site-nav">`) — left side: name only ("Viktor Demydov", home link, no avatar image); right side: icon-only links (LinkedIn, GitHub); constrained to 900px via `.site-nav__inner`
